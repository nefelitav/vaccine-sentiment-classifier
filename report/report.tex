...
\\ \\ \\
\subsection{Models}
The model I created consists of 3 linear layers, the input size is equal to the dimension of the embeddings and the output size is equal to the number of classes (3). 
...
$
\\ \\ \\
Also, I experimented with some more activation functions, eg softmin, logsoftmax, or dropout but still the best results were the ones I mentioned before. \\
...
\begin{center}
\includegraphics[width=120mm]{loss}
\end{center}
\begin{center}
\includegraphics[width=120mm]{accuracy}
\end{center}
